...
psql "$DB_URL" -c "SET udie.allow_derived_mutation = 'true'; TRUNCATE geo_events, risk_cells CASCADE; RESET udie.allow_derived_mutation;"
...
psql "$DB_URL" -c "
SET udie.allow_derived_mutation = 'true';
...
RESET udie.allow_derived_mutation;
"

# 4. Refresh Surface
echo "Step 4: Materializing Risk Surface..."
time psql "$DB_URL" -c "SET udie.allow_derived_mutation = 'true'; SELECT refresh_risk_surface(); RESET udie.allow_derived_mutation;"
